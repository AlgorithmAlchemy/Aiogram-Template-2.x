"""
Базовый класс для всех хэндлеров команд
"""
...
class BaseCallbackHandler(ABC):
    ...
    def register_handlers(self):
        ...
        logger.info(f"Registered callback handler for: {self.get_callback_data()}")
...
class BaseMessageHandler(ABC):
    ...
    def register_handlers(self):
        ...
        logger.info(f"Registered message handler for: {self.get_content_types()}")
